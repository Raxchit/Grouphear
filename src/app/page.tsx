  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Button size="lg" variant="outline" onClick={() => scrollTo("features")} className="border-orange-500/40">
        ...
        {/* ─── BUILD & PUBLISH GUIDE ─── */}
        {/* Build & Publish section — hidden from public view */}
        {/* <section id="build" className="py-20 md:py-28">
          ... (Flutter / Android / iOS / Website publishing guide)
        </section> */}
          ...
          <div className="max-w-3xl mx-auto px-4 text-center space-y-6">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="space-y-4">
              ...
              <div className="flex justify-center gap-4">
                ...
                <Button size="lg" variant="outline" onClick={() => scrollTo("how")} className="border-orange-500/40">
                  <Wifi className="w-5 h-5 mr-2" /> How It Works
                </Button>
              </div>
            </motion.div>
          </div>
